package Automation.IAQ.Regression.Rates.IL;
...
public class Rates_HO6 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("TT:\\Automations\\ExtentReports\\IAQ\\Regression\\Rates\\IL\\Rates_HO6\\Rates_HO6-" + GetDateTime() + ".html");
	
	@DataProvider(name="Rates_HO6")
	public String[][] GetRates_HO6DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO6", "Regression", "IL");
		return data;
	}
