package Automation.IAQ.Regression.Rates.TX;
...
public class Rates_HO3 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Regression\\Rates\\TX\\Rates_HO3\\Rates_HO3-" + GetDateTime() + ".html");

	@DataProvider(name="Rates_HO3")
	public String[][] GetRates_HO3DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO3", "Regression", "TX");
		return data;
	}
	...
	public void RunRates_HO3(String casenum, String state, String planid, String pgragentid, String asiagentid, String fname, String lname,
		...
		try {
			...
			if(!premium.equals(CBP.ReturnPremium("N"))) {
				...
				if(!openfoundation.equalsIgnoreCase(PRP2.ReturnOpenFoundation())) {
						Log("Open Foundation: " + openfoundation + "-" + PRP2.ReturnOpenFoundation());
				}
				...
				if(!limitedfoundation.equalsIgnoreCase(PRP2.ReturnLimitedFoundationandSlabBuyback())) {
						Log("Limited Foundation and Slab Buyback: " + limitedfoundation + "-" + PRP2.ReturnLimitedFoundationandSlabBuyback());
				}
				...
				e.printStackTrace();
				GetFailScreenShot(casenum + "-TX_HO3_Error");
