...
public class Rates_HO4 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Regression\\Rates\\MT\\Rates_HO4\\Rates_HO4-" + GetDateTime() + ".html");

	@DataProvider(name="Rates_HO4")
	public String[][] GetRates_HO4DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO4", "Regression", "MT");
		return data;
	}
	...
	public void RunRates_HO4(String casenum, String state, String planid, String pgragentid, String asiagentid, String fname, String lname,
		...
		try {
			...
			if(!premium.equals(CBP.ReturnPremium("N"))) {
				...
				GetFailScreenShot(casenum + "-MT_HO4_Error");
