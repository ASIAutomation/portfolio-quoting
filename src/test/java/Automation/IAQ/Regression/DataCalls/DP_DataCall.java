...
public class DP_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Regression\\DataCalls\\DP_DataCall\\DP_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="DP_DataCall")
	public String[][] GetDP_DataCall() {
		String[][] data = GetData("Data", "DP_DataCall", "Regression",  "datacalls");
		return data;
	}
