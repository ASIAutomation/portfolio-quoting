...
public class CR_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Regression\\DataCalls\\CR_DataCall\\CR_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="CR_DataCall")
	public String[][] GetCR_DataCall() {
		String[][] data = GetData("Data", "CR_DataCall", "Regression", "datacalls");
		return data;
	}
