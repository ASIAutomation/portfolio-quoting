package Automation.IAQ.Testing.Rates.TN;
...
public class Rates_HO3 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\Rates\\TN\\Rates_HO3\\Rates_HO3-" + GetDateTime() + ".html");

	@DataProvider(name="Rates_HO3")
	public String[][] GetRates_HO3DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO3", "Testing", "TN");
		return data;
	}
	...
	public void RunRates_HO3(String casenum, String state, String planid, String pgragentid, String asiagentid, String fname, String lname,
		...
		try {
			...
			if(newpurch.toUpperCase().equals("Y") || newpurch.toUpperCase().equals("YES") || newpurch.toUpperCase().equals("1")) {
				...
				Pause(500);
			if(builderwarrenty.toUpperCase().equals("Y") || builderwarrenty.toUpperCase().equals("YES")) {
			...
			if(driver.getPageSource().contains("Builder Warranty")) {
				AD.SelectBuilderWarrenty(builderwarrenty);
			}
			...
			if(raterprem - iaqprem > 1 || iaqprem-raterprem > 1) {
				...
				if(!builderwarrenty.equalsIgnoreCase(PRP2.ReturnAccreditedBuilder())) {
						Log("Builder Warranty Discount: " + builderwarrenty + "-" + PRP2.ReturnAccreditedBuilder());
				}
				...
				if(!sinkhole.equalsIgnoreCase(PRP2.ReturnSinkhole())) {
						Log("Sinkhole: " + sinkhole + "-" + PRP2.ReturnSinkhole());
				}
