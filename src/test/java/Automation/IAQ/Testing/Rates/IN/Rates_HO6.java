...
public class Rates_HO6 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\Rates\\IN\\Rates_HO6\\Rates_HO6-" + GetDateTime() + ".html");
	
	@DataProvider(name="Rates_HO6")
	public String[][] GetRates_HO6DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO6", "Testing", "IN");
		return data;
	}
	...
	public void RunRates_HO6(String casenum, String state, String planid, String pgragentid, String asiagentid, String fname, String lname,
		...
		try {
			...
			CBP.SelectWaterBackupSumpPumpLimit(waterbackup);
				Pause(3000);
			...
			if(raterprem - iaqprem > 1 || iaqprem-raterprem > 1) {
				...
				if(!waterbackup.equalsIgnoreCase(PRP2.ReturnWaterBackupSumpPump())) {
						Log("Water Backup/Sump Pump: " + waterbackup + "-" + PRP2.ReturnWaterBackupSumpPump());
				}
			...
			QuitBrowser();
				...
				e.printStackTrace();
				GetFailScreenShot(casenum + "-IN_HO6_Error");
