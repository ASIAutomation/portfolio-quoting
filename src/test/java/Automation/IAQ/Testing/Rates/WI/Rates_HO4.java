...
public class Rates_HO4 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\Rates\\WI\\Rates_HO4\\Rates_HO4-" + GetDateTime() + ".html");

	@DataProvider(name="Rates_HO4")
	public String[][] GetRates_HO4DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO4", "Testing", "WI");
		return data;
	}
