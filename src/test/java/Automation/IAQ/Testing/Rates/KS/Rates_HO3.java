...
public class Rates_HO3 extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\Rates\\KS\\Rates_HO3\\Rates_HO3-" + GetDateTime() + ".html");

	@DataProvider(name="Rates_HO3")
	public String[][] GetRates_HO3DataCall() {
		String[][] data = GetData("IAQPoldata", "Rates_HO3", "Testing", "KS");
		return data;
	}
	...
	public void RunRates_HO3(String casenum, String state, String planid, String pgragentid, String asiagentid, String fname, String lname,
		...
		try {
			...
			if(raterprem - iaqprem > 1 || iaqprem-raterprem > 1) {
				...
				if(!matchundmgsiding.equalsIgnoreCase(PRP2.ReturnMatchingofUndamagedSidingRoofing())) {
						Log("Matching of Undamaged Siding and/or Roofing: " + matchundmgsiding + "-" + PRP2.ReturnMatchingofUndamagedSidingRoofing());
				}
			...
			e.printStackTrace();
			GetFailScreenShot(casenum + "-KS_HO3_Error");
