...
public class BF_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO3\\BF_DataCall\\BF_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="BF_DataCall")
	public String[][] GetBF_DataCall() {
		String[][] data = GetData("Data", "BF_DataCall", "Testing", "datacalls/HO3");
		return data;
	}
