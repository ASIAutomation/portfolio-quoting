...
public class CL_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO3\\CL_DataCall\\CL_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="CL_DataCall")
	public String[][] GetCL_DataCall() {
		String[][] data = GetData("Data", "CL_DataCall", "Testing", "datacalls/HO3");
		return data;
	}
