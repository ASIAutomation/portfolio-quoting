...
public class PC_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO3\\PC_DataCall\\PC_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="PC_DataCall")
	public String[][] GetPC_DataCall() {
		String[][] data = GetData("Data", "PC_DataCall", "Testing", "datacalls/HO3");
		return data;
	}
