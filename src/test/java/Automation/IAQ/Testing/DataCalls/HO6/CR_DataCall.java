...
public class CR_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO6\\CR_DataCall\\CR_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="CR_DataCall")
	public String[][] GetCR_DataCall() {
		String[][] data = GetData("Data", "CR_DataCall", "Testing", "datacalls/HO6");
		return data;
	}
