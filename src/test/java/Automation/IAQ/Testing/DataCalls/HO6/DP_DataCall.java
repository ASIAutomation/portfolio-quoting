package Automation.IAQ.Testing.DataCalls.HO6;
...
public class DP_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO6\\DP_DataCall\\DP_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="DP_DataCall")
	public String[][] GetDP_DataCall() {
		String[][] data = GetData("Data", "DP_DataCall", "Testing", "datacalls/HO6");
		return data;
	}
	...
	public void RunDP_DataCall(String casenum, String pgragentid, String state, String asiagentcode, String fname, String lname, String mailaddy1,
		String city, String zip, String expyrhomebuilt, String exptypeconstr, String explivingarea, String expfullbaths, String expheatsource, String expdeck) throws InterruptedException {
