package Automation.IAQ.Testing.DataCalls.HO4;
...
public class CR_DataCall extends TestBase {
	...
	ExtentHtmlReporter reporter = new ExtentHtmlReporter("T:\\Automations\\ExtentReports\\IAQ\\Testing\\DataCalls\\HO4\\CR_DataCall\\CR_DataCall-" + GetDateTime() + ".html");
	
	@DataProvider(name="CR_DataCall")
	public String[][] GetCR_DataCall() {
		String[][] data = GetData("Data", "CR_DataCall", "Testing", "datacalls/HO4");
		return data;
	}
	...
	public void RunCR_DataCall(String casenum, String pgragentid, String state, String asiagentcode, String fname, String lname,
		...
		try {
			...
			if(driver.getPageSource().contains("Floors Above Unit")) {
				AD.SelectFloorsAboveUnit("No Floors Above");
					Pause(500);
			}
			...
			if(driver.getPageSource().contains("Renter Occupied")) {
				AD.SelectRenterOccupied("No");
					Pause(500);
			}
